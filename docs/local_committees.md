...
- <p class="pos_fixed">![Image title](assets/images/JXZ.png){ align=center, width=50%, height=50% }<br><strong>Jian-Xin Zhu</strong><br><strong>(Conference Chair)</strong> <br><i>Los Alamos National Laboratory</i> </p>

- <p class="pos_fixed">![Image title](assets/images/MC.png){ align=center, width=50%, height=50% }<br><strong>Mun Chan</strong> <br><i>National High Magnetic Field Laboratory: Pulsed Field Facility</i></p>

- <p class="pos_fixed">![Image title](assets/images/EK.png){ align=center, width=50%, height=50% }<br><strong>Elizabeth Krenkel</strong> <br><i>Los Alamos National Laboratory</i></p>

- <p class="pos_fixed">![Image title](assets/images/CL.png){ align=center, width=50%, height=50% }<br><strong>Christopher Lane</strong> <br><i>Los Alamos National Laboratory</i></p>

- <p class="pos_fixed">![Image title](assets/images/YWL.png){ align=center, width=50%, height=50% }<br><strong>Ying Wai Li</strong> <br><i>Los Alamos National Laboratory</i></p>
...
- <p class="pos_fixed">![Image title](assets/images/FR.png){ align=center, width=50%, height=50% }<br><strong>Filip Ronning</strong><br><strong>(Chair)</strong> <br><i>Los Alamos National Laboratory</i> </p>

- <p class="pos_fixed">![Image title](assets/images/JP.png){ align=center, width=50%, height=50% }<br><strong>Jed Pixley</strong><br><strong>(Co-Chair)</strong> <br><i>Rutger University</i></p>

- <p class="pos_fixed">![Image title](assets/images/JT.png){ align=center, width=50%, height=50% }<br><strong>Joe D. Thompson</strong> <br><i>Los Alamos National Laboratory</i></p>

- <p class="pos_fixed">![Image title](assets/images/SB.png){ align=center, width=50%, height=50% }<br><strong>Stuart Brown</strong> <br><i>University of California at Los Angeles</i></p>

- <p class="pos_fixed">![Image title](assets/images/MY.png){ align=center, width=50%, height=50% }<br><strong>Ming Yi</strong> <br><i>Rice University</i></p>

- <p class="pos_fixed">![Image title](assets/images/JXZ.png){ align=center, width=50%, height=50% }<br><strong>Jian-Xin Zhu</strong> <br><i>Los Alamos National Laboratory</i></p>
...
- <img src="../assets/images/FR.png" style="object-fit: cover;object-position: 50% 50%;"> { .lg .middle}__LLL__

- <img src="../assets/images/JP.png" style="object-fit: cover;object-position: 50% 50%;"> { .lg .middle}__LLL__

- <img src="../assets/images/JT.png" style="object-fit: cover;object-position: 50% 50%;"> { .lg .middle}__LLL__

- <img src="../assets/images/SB.png" style="object-fit: cover;object-position: 50% 50%;"> { .lg .middle}__LLL__

- <img src="../assets/images/JXZ.png" style="object-fit: cover;object-position: 50% 50%;"> { .lg .middle}__LLL__
